...
export default function LoginPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4 bg-slate-100">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100">
        <div className="text-center">
          <Link href="/" className="inline-block text-3xl mb-2">🧠</Link>
          <h1 className="text-2xl font-bold text-slate-900">مرحباً بعودتك! 👋</h1>
          <p className="mt-1 text-sm text-slate-500">سجل دخولك لمتابعة خطة مراجعتك اليومية</p>
        </div>
